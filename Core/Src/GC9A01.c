...
#define RESET_ON            HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, GPIO_PIN_SET)
#define RESET_OFF           HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, GPIO_PIN_RESET)
#define DC_ON               HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_SET)
#define DC_OFF              HAL_GPIO_WritePin(GPIOA, GPIO_PIN_8, GPIO_PIN_RESET)
...
//Definidos por fgarcia
extern SPI_HandleTypeDef hspi1;
#define GC9A01_spi_tx(data, size) HAL_SPI_Transmit(&hspi1, data, size, HAL_MAX_DELAY)
